...
try {
    let result=await axios.post("https://back-end-2-hqhl.onrender.com/api/product/addproduct",product)
...
dispatch({type:LOAD_PRODUCT})
try {
let result= await axios.put(`https://back-end-2-hqhl.onrender.com/api/product/updateproduct/${_id}`,{price})
